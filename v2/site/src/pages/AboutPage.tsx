...
export function AboutPage() {
  return (
    <>
      <SEO
        title="About - Learn About Bufo"
        description="Learn more about bufo.fun and our delightful collection of bufo emojis. Explore, search, and discover quite a few bufos for your discord and slack servers!"
        keywords="bufo, about, frog, emoji, collection"
