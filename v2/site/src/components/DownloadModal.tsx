      ...
      <div className="p-4 text-sm flex flex-col space-y-4 min-w-80">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-gray-200 rounded-md focus:border-bufo-400 focus:outline-none focus:ring-2 focus:ring-bufo-200 transition-all duration-200"
          >
